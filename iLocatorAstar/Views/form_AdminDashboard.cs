...
namespace iLocatorAstar
{
    public partial class form_AdminDashboard : Form
    {
        ...
        private void btn_SideNav_BlockPath_Click(object sender, EventArgs e)
        {
            panel_UniverseAdmin.Controls.Clear();

            UC_BlockPath frm_BlockPath = new UC_BlockPath();
            panel_UniverseAdmin.Controls.Add(frm_BlockPath);
            frm_BlockPath.Dock = DockStyle.Fill;
        }
